...
**Tests**: Tests are REQUIRED. Every feature task plan MUST include testing tasks
that follow the testing pyramid and enforce >=80% line coverage for business
logic.
...
- [ ] T005 [P] Configure coverage reporting for business-logic paths (>=80%)
- [ ] T006 [P] Configure JSDoc validation/check tooling
...
- [ ] T015 [US1] Coverage gate update to keep business-logic coverage >=80%
...
- [ ] T022 [US1] Add/update JSDoc for public and business-logic APIs in changed files
...
- [ ] T025 [US2] Coverage gate update to keep business-logic coverage >=80%
...
- [ ] T030 [US2] Add/update JSDoc for public and business-logic APIs in changed files
...
- [ ] T033 [US3] Coverage gate update to keep business-logic coverage >=80%
...
- [ ] T037 [US3] Add/update JSDoc for public and business-logic APIs in changed files
