...
**Tests**: Tests are REQUIRED. Every feature task plan MUST include
specification-derived tests written before implementation, target an
approximate 70/20/10 unit/integration/e2e split, enforce >=80% line,
>=75% branch, and >=75% mutation thresholds for business logic, and include
...
- [ ] T004 [P] Configure TypeScript strict mode and type-check script
- [ ] T005 [P] Configure coverage reporting for business-logic paths (>=80% line, >=75% branch)
- [ ] T006 [P] Configure mutation testing and threshold gate (>=75%)
- [ ] T007 [P] Configure JSDoc validation/check tooling
...
- [ ] T014 [P] [US1] Unit tests for business logic in tests/unit/test_[name].py
- [ ] T015 [P] [US1] Integration test for [user journey] in tests/integration/test_[name].py
- [ ] T016 [US1] Coverage and mutation gate update (>=80% line, >=75% branch, >=75% mutation)
...
- [ ] T023 [US1] Add/update JSDoc for public and business-logic APIs in changed files
...
- [ ] T024 [P] [US2] Unit tests for business logic in tests/unit/test_[name].py
- [ ] T025 [P] [US2] Integration test for [user journey] in tests/integration/test_[name].py
- [ ] T026 [US2] Coverage and mutation gate update (>=80% line, >=75% branch, >=75% mutation)
...
- [ ] T031 [US2] Add/update JSDoc for public and business-logic APIs in changed files
...
- [ ] T032 [P] [US3] Unit tests for business logic in tests/unit/test_[name].py
- [ ] T033 [P] [US3] Integration test for [user journey] in tests/integration/test_[name].py
- [ ] T034 [US3] Coverage and mutation gate update (>=80% line, >=75% branch, >=75% mutation)
...
- [ ] T038 [US3] Add/update JSDoc for public and business-logic APIs in changed files
...
- [ ] TXXX [P] Additional unit tests to preserve testing pyramid shape in tests/unit/
...
Task: "Unit tests for business logic in tests/unit/test_[name].py"
