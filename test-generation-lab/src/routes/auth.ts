...
router.post('/logout', authenticate, asyncRoute(async (req, res, next) => {
  try {
    if (!req.auth) {
...
router.post('/request-reset', asyncRoute(async (req, res, next) => {
  try {
...
router.post('/reset-password', asyncRoute(async (req, res, next) => {
  try {
